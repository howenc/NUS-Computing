...
const increment_repeater = 
        twice =>                                        //the input of i_r must be twice see line 29
        display =>                                      //the input of twice must be display see line 30
        inputofdisplay =>                               //the input of display must be the string "Alert" see line 31
      ...
      //display(display(display(inputofdisplay)         //but this means that it is hardcoded to have 3
                                                        ...
                                                        //twice(display(inputofdisplay))(display) doesn't work as it contradicts line 28

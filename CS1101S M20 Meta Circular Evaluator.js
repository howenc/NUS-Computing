...
const primitive_functions = list(
       ...
       list("+",       (x, y) => (is_unary_operator_combination(x) && is_unary_operator_combination(y)) 
                                    ? x + y
                                    : append(x,y)),
       list("-",       (x, y) => x - y  ),
       list("-unary",   x     =>   - x  ),
       ...
       list("<",       (x, y) => x <   y),
       list("<=",      (x, y) => x <=  y),
       list(">",       (x, y) => ((is_compound_function(x)||is_primitive_function(x)) && is_list(y))
                                    ? map(i => apply(x,list(i)),y)
                                    : x >   y),
       list(">=",      (x, y) => x >=  y),
       list("!",        x     =>   !   x)
       );
...
count_function_objects_created(`const x = 30;
                    const y = 40;
                    function f(a,b) {
                        const z = 50;
                        }
